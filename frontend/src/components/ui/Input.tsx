    ...
    <div className="relative w-full">
      ...
      }
     {
      ...
      <input 
        ...
        className={`w-full border border-gray-300 p-3 rounded-lg ${props.icon ? "pl-12" : "pl-3"} ${localError ? "border-red-500 focus:border-red-500 focus:ring-red-500" : "focus:border-sky-600 focus:ring-sky-600 hover:border-sky-600 hover:ring-sky-600"} ${props.className}`}
      />
      {
        localError &&
